...
class InsertAndUpdateResources extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $resourcesArr = [
            ...
            [
                'name'   => 'employee_work_detail_action',
                'display_name' => 'Employee Work Detail Action',
                'description' => 'Employee Work Detail Action',
            ],
            [
                'name'   => 'personal-info',
