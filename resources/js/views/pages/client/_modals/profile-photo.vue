...
export default {
    ...
    data() {
        return {
            ...
            show: false,
            profile: {
                folder: 'client-profile-photo',
                assetable_id: '',
                assetable_type: 'clients',
                medium: null,
                store_type: 'profile',
                medium_type: 'image'
            }
    ...
    created() {
        this.profile.assetable_id = this.client.id;
        // load initial image
        this.profile.medium = this.photo;
        this.profile.folder += '/' + this.client.id;
    },
    components: {
        SaveButton,
        ModalDialog,
    ...
    methods: {
        save() {
            ...
            asset.save(this.profile).then((res) => {
                this.loading = false;
                this.$emit('success');
            });
        },
