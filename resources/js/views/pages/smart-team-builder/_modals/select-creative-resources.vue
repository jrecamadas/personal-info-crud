							...
							<div class="row" :class="{ 'show': navigationCounter == 1 }">
								<div class="col-sm-12">
									<div class="checkbox-wrapper">
										<input type="radio" class="checkbox" id="graphic" name="graphic" value="graphic" v-model="question1" @change="checkIfChecked(question1)" />
										<label for="graphic"><span>Graphic Design</span></label>
									</div>
								</div>
								<div class="col-sm-12">
									<div class="checkbox-wrapper">
										<input type="radio" class="checkbox" id="video" name="video" value="video" v-model="question1" @change="checkIfChecked(question1)"/>
										<label for="video"><span>Video Production</span></label>
									</div>
								</div>
							</div>

							<!-- SLIDE 2.1 -->
							<div class="row" :class="{ 'show': navigationCounter == 2.1 }">
								<div class="col-sm-12">
									<h5>What do you want to design?</h5>
								</div>
								<div class="col-sm-6">
									<div class="checkbox-wrapper">
										<input type="checkbox" class="checkbox" id="ui" name="ui" value="ui" v-model="question2_1" @change="checkIfChecked(question2_1)" />
										<label for="ui" class="small"><span>UI / UX</span></label>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="checkbox-wrapper">
										<input type="checkbox" class="checkbox" id="home" name="home" value="home" v-model="question2_1" @change="checkIfChecked(question2_1)"/>
										<label for="home" class="small"><span>Homepage</span></label>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="checkbox-wrapper">
										<input type="checkbox" class="checkbox" id="marketing" name="marketing" value="marketing" v-model="question2_1" @change="checkIfChecked(question2_1)"/>
										<label for="marketing" class="small"><span>Marketing stuff</span></label>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="checkbox-wrapper">
										<input type="checkbox" class="checkbox" id="custom" name="custom" value="custom" v-model="question2_1" @change="checkIfChecked(question2_1)"/>
										<label for="custom" class="small"><span>Custom</span></label>
									</div>
								</div>
							</div>

							<!-- SLIDE 2.2 -->
							<div class="row" :class="{ 'show': navigationCounter == 2.2 }">
								<div class="col-sm-12">
									<h5>What do you want to design?</h5>
								</div>
								<div class="col-sm-6">
									<div class="checkbox-wrapper">
										<input type="checkbox" class="checkbox" id="explainer" name="explainer" value="explainer" v-model="question2_2" @change="checkIfChecked(question2_2)" />
										<label for="explainer" class="small"><span>Explainer</span></label>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="checkbox-wrapper">
										<input type="checkbox" class="checkbox" id="promotional" name="promotional" value="promotional" v-model="question2_2" @change="checkIfChecked(question2_2)"/>
										<label for="promotional" class="small"><span>Promotional</span></label>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="checkbox-wrapper">
										<input type="checkbox" class="checkbox" id="educational" name="educational" value="educational" v-model="question2_2" @change="checkIfChecked(question2_2)"/>
										<label for="educational" class="small"><span>Educational</span></label>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="checkbox-wrapper">
										<input type="checkbox" class="checkbox" id="announcement" name="announcement" value="announcement" v-model="question2_2" @change="checkIfChecked(question2_2)"/>
										<label for="announcement" class="small"><span>Announcement</span></label>
									</div>
								</div>
							</div>
											...
											<div class="slide-wrapper">
												...
												<div class="emp-info">
													...
													<div>
														Position: <br/>
														<div class="three-ellipsis">
															<span class="creative-position" data-trigger="hover" data-toggle="popover" :data-popover-content="'#popover-creative-' + index">
													...
													<popover-dialog :popoverId="'popover-creative-' + index">
...
<script>
	...
	export default {
		...
		methods: {
			...
			nextSlide(){
				if(this.navigationCounter == 1) {
					if(this.question1 == "graphic") {
						this.navigationCounter = 2.1;
					} else {
						this.navigationCounter = 2.2;
					}
				} else {
					this.navigationCounter = 3;
				}
			...
			async conditionalNavigation() {
				if(this.navigationCounter == 3){
					...
					this.loading = false;
				} else if(this.navigationCounter == 1){
					...
					if (this.navigationCounter == 2.1) {
						this.checkIfChecked(this.question2_1);
					} else if (this.navigationCounter == 2.2) {
						this.checkIfChecked(this.question2_2);
					}
					this.next = true;
					this.prev = true;
					this.done = false;
					this.activeHeight = 145;
					this.option.width = '500px';
				}
			},
			async getData(){
			...
			getPositionId(positions){
				let id = positions.filter(function(e) { return e.position_id == '30' || e.position_id == '31'|| e.position_id == '49'|| e.position_id == '55'})[0].position_id;
				return id;
			},
		...
		destroyed() {
			$('.creative-position').popover('dispose');
		},
		components: {
	        GenerateButton,
	        SaveButton,
