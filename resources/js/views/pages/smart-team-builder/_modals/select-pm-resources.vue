                    ...
                    <div class="row question-wrapper">
                        <div class="col-sm-12" :style="{ height: activeHeight + 'px' }">
							...
							<div class="row" :class="{ 'show': navigationCounter == 1 }">
								<div class="col-sm-12">
									<h5>• Do you have a project manager you use right now?</h5>
									<div class="row small-container">
										<div class="col-sm-6">
											<div class="checkbox-wrapper">
												<input type="radio" class="checkbox" id="choice1" value="Yes" v-model="question1" @change="checkIfChecked()" />
												<label for="choice1" class="small"><span>Yes</span></label>
											</div>
										</div>
										<div class="col-sm-6">
											<div class="checkbox-wrapper">
												<input type="radio" class="checkbox" id="question2" value="No" v-model="question1" @change="checkIfChecked()"/>
												<label for="question2" class="small"><span>No</span></label>
											</div>
										</div>
									</div>
								</div>
								<div class="col-sm-12">
									<h5>• Do you currently use project management software?</h5>
									<div class="row small-container">
										<div class="col-sm-6">
											<div class="checkbox-wrapper">
												<input type="radio" class="checkbox" id="choice3" value="Yes" v-model="question2" @change="checkIfChecked()" />
												<label for="choice3" class="small"><span>Yes</span></label>
											</div>
										</div>
										<div class="col-sm-6">
											<div class="checkbox-wrapper">
												<input type="radio" class="checkbox" id="choice4" value="No" v-model="question2" @change="checkIfChecked()"/>
												<label for="choice4" class="small"><span>No</span></label>
											</div>
										</div>
									</div>
								</div>
											...
											<div class="slide-wrapper">
												...
												<div class="emp-info">
													...
													<div>
														Position: <br/>
														<div class="three-ellipsis">
															<span class="pm-position" data-trigger="hover" data-toggle="popover" :data-popover-content="'#popover-pm-' + index">
													...
													<popover-dialog :popoverId="'popover-pm-' + index">
