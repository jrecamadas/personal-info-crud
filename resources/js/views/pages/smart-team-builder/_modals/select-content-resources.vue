                    ...
                    <div class="row question-wrapper">
                        <div class="col-sm-12" :style="{ height: activeHeight + 'px' }">
							...
							<div class="row" :class="{ 'show': navigationCounter == 1 }">
								<div class="col-sm-12">
									<h5>What type of content do you want to create?</h5>
								</div>
								<div class="col-sm-12">
									<div class="checkbox-wrapper">
										<input type="checkbox" class="checkbox" id="general" name="general" value="general" v-model="question1" @change="checkIfChecked(question1)" />
										<label for="general" class="small"><span>General website content</span></label>
									</div>
								</div>
								<div class="col-sm-12">
									<div class="checkbox-wrapper">
										<input type="checkbox" class="checkbox" id="blog" name="blog" value="blog" v-model="question1" @change="checkIfChecked(question1)"/>
										<label for="blog" class="small"><span>Blog articles</span></label>
									</div>
								</div>
								<div class="col-sm-12">
									<div class="checkbox-wrapper">
										<input type="checkbox" class="checkbox" id="how" name="how" value="how" v-model="question1" @change="checkIfChecked(question1)"/>
										<label for="how" class="small"><span>How to or support articles</span></label>
									</div>
								</div>
							</div>
											...
											<div class="slide-wrapper">
												...
												<div class="emp-info">
													...
													<div>
														Position: <br/>
														<div class="three-ellipsis">
															<span class="content-position" data-trigger="hover" data-toggle="popover" :data-popover-content="'#popover-content-' + index">
													...
													<popover-dialog :popoverId="'popover-content-' + index">
	...
	export default {
		...
		methods: {
			...
			getPositionId(positions){
				let id = positions.filter(function(e) { return e.position_id == '33' || e.position_id == '34'|| e.position_id == '35'})[0].position_id;
				return id;
			},
		...
		destroyed() {
			$('.content-position').popover('dispose');
		},
		components: {
	        GenerateButton,
	        SaveButton,
